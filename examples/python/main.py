"""
Example: How to call the property-meinestandt-de-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/property-meinestandt-de-scraper
...
def run_actor():
    """Run the property-meinestandt-de-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/property-meinestandt-de-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.meinestadt.de/augsburg/immobilien"}],
            "maxItems": 10,
